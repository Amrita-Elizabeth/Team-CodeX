...
using Tesseract;
using Preprocessing; // Assuming your Rotation class is in this namespace
using OCRProject.Services; // Import the OCRProcessor class
...
class Program
{
    static void Main(string[] args)
    {
        ...
        string inputFolderPath = @"C:\Users\Molly\Documents\Project\Team-CodeX\ConsoleApp\Image_input";
        string outputFolderPath = @"C:\Users\Molly\Documents\Project\Team-CodeX\ConsoleApp\Processed_data";
        string tessDataPath = @"C:\Users\Molly\Documents\Project\Team-CodeX\ConsoleApp\tessdata";
        ...
        var ocrProcessor = new OcrProcessor(tessDataPath);
        ...
        foreach (string file in imageFiles)
        {
            try
            {
                ...
                string extractedText = ocrProcessor.ExtractText(new Bitmap(rotatedImage));
